<!-- contents -->
<div class="main_content" id="group_diskusi">
  ...
  <div class="main_content_inner">
    ...
    <div class="uk-flex uk-flex-between">
      ...
      <a href="#" class="button primary small circle uk-visible@s text-decoration-none"> <i class="uil-plus"> </i> Create New Group
      </a>
        ...
        <ul class="uk-slider-items uk-child-width-1-4@m uk-child-width-1-3@s  pr-lg-1 uk-grid" uk-scrollspy="target: > div; cls: uk-animation-slide-bottom-small; delay: 100">
          ...
          <li>
            <div class="group-card">
              ...
              <div class="group-card-content">
                ...
                <p class="info"> <a href="#" class="text-decoration-none"> <span> 120 Members </span> </a>
                ...
                <div class="group-card-btns">
                  ...
                  <a href="<?= base_url('group/profilegroup') ?>" class="button secondary small text-decoration-none"> View </a>
                </div>
          ...
          <li>
            <div class="group-card">
              ...
              <!-- Group Card Thumbnail -->
              <div class="group-card-thumbnail">
                <img src="<?= base_url('assets/images/group/group-5.jpg'); ?>" alt="">
              </div>

              <!-- Group Card Content -->
              <div class="group-card-content">
                <h3> DKV Angkatan 2019 </h3>
                <p class="info"> <a href="#" class="text-decoration-none"> <span> 160 Members </span> </a>
                  <a href="#" class="text-decoration-none"> <span> 1000 Post </span> </a>
                </p>
                <div class="group-card-member-wrap">
                  <div class="avatar-group uk-width-auto">
                    <img alt="Image placeholder" src="<?= base_url('assets/images/avatars/avatar-5.jpg'); ?>" class="avatar avatar-xs rounded-circle">
                  ...
                  <div class="uk-width-expand pl-2">
                    <p> <strong> Monica Tifani </strong> and 5 Other are Members </p>
                  </div>
                </div>
          ...
          <li>
            <div class="group-card">
              ...
              <!-- Group Card Thumbnail -->
              <div class="group-card-thumbnail">
                <img src="<?= base_url('assets/images/group/group-4.jpg'); ?>" alt="">
              </div>

              <!-- Group Card Content -->
              <div class="group-card-content">
                <h3> International Seminar </h3>
                <p class="info"><a href="#" class="text-decoration-none"><span> 1000 members </span> </a>
                  <a href="#" class="text-decoration-none"> <span> 100 Post </span> </a>
                </p>
                <div class="group-card-member-wrap">
                  <div class="avatar-group uk-width-auto">
                    <img alt="Image placeholder" src="<?= base_url('assets/images/avatars/avatar-1.jfif'); ?>" class="avatar avatar-xs rounded-circle">
                    <img alt="Image placeholder" src="<?= base_url('assets/images/avatars/avatar-5.jpg'); ?>" class="avatar avatar-xs rounded-circle">
                  </div>
                  <div class="uk-width-expand pl-2">
                    <p> <strong> Melanaumi Apriza </strong> and 6 Other are Members </p>
                  </div>
                </div>
    ...
    <nav class="responsive-tab style-4 mb-3">
      <ul>
        <li class="uk-active"><a href="#" class="text-decoration-none"> All Groups <span> 2.987 </span> </a></li>
          ...
          <div>
            <div class="list-items">
              ...
              <div class="list-item-content">
                ...
                <p> Mahasiswa Teknik Informatika 2017 </p>
              </div>
