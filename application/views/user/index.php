  ...
  <div class="uk-offcanvas-bar">
    <div class="sidebar-chat-head mb-2">
      <div class="btn-actions">
        <a href="#" uk-tooltip="title: Search ;offset:7" uk-toggle="target: .sidebar-chat-search; animation: uk-animation-slide-top-small">
    ...
    <div class="sidebar-chat-search" hidden>
      ...
      <span class="btn-close" uk-toggle="target: .sidebar-chat-search; animation: uk-animation-slide-top-small">
    ...
    <a href="#">
      <div class="contact-list">
        ...
        <!-- nah ini buat online dot nya, gatau gimana caranya biar tau dia online apa ga -->
        <h5>Mahsa Savira</h5>
      </div>
    </a>
